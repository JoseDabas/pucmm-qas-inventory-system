...
/**
 * Pruebas de contrato de API para los endpoints de movimientos de stock.
...
class StockMovementApiContractTest {
    ...
    void testGetStockMovementsWithoutAuthorizationReturns401() {
        RestAssured
            .given()
            .when()
