...
class GlobalExceptionHandlerTest {
    ...
    void shouldCoverAllExceptionHandlers() {
        ...
        HttpMessageNotReadableException ex1 = new HttpMessageNotReadableException("error", mock(HttpInputMessage.class));
        ...
        ProblemDetail pd7 = handler.handleDataIntegrityViolationException(new DataIntegrityViolationException("integrity"));
        ...
        // 9. Exception general
        ProblemDetail pd9 = handler.handleException(new Exception("generic"));
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR.value(), pd9.getStatus());
    }
}